...
import {TERRAFORM_VERSION_CONSTRAINTS} from "../../utils/constants"
import { TerraformRegistryService } from "./terraformRegistryService";

export class HclVersionService{
    constructor(private readonly terraformFetchService: TerraformRegistryService) {
    }
    /**
